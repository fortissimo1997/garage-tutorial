class PostsController < ApplicationController
  ...
  validates :create do
    string :title, required: true, description: 'You can not specify title as empty string.'
    string :body, description: 'Blog contents. Empty string is allowed.'
  end

  validates :update do
    string :title, description: 'You can not specify title as empty string.'
    string :body, description: 'Blog contents. Empty string is allowed.'
